...
public abstract class Button {
     ...
     * @return The ItemButton, which can be added to an InventoryGUI
     */
    public static Button create(String itemName, ItemStack item, Consumer<InventoryClickEvent> listener) {
     ...
     * @return The ItemButton, which can be added to an InventoryGUI
     */
    public static Button create(String itemName, ItemStack item, int slot, BiConsumer<InventoryClickEvent, Button> listener) {
    ...
    public Button(String itemName, ItemStack item) {
        this.item = item;
    ...
    public Button(String itemName, ItemStack item, int slot) {
        this.item = item;
        this.slot = slot;
        ItemMeta itemMeta = item.getItemMeta();
        if (itemMeta != null) {
